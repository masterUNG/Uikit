...
class _WalkthroughScreen02State extends State<WalkthroughScreen02> {
      ...
      child: Scaffold(
        ...
        body: LayoutBuilder(
          builder: (context, constraints) => Stack(
            children: [
              buildImage(constraints, listCarouselPage),
              buildInstruction(listCarouselPage),
  ...
  Container continueButton(BoxConstraints constraints) {
    return Container(
  ...
  Container buildInstruction(List<Widget> listCarouselPage) {
    return Container(
      alignment: Alignment.bottomCenter,
  ...
  Container buildImage(
      BoxConstraints constraints, List<Widget> listCarouselPage) {
    return Container(
